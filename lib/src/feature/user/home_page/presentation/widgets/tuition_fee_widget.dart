                                                          ...
                                                          padding: EdgeInsets
                                                              .symmetric(
                                                                  ...
                                                                  horizontal:
                                                                      5),
                                                          decoration: BoxDecoration(
                                                              color: data.status == TransactionStatus.paid
                                                                  ? KColor.green
                                                                  : data.status == TransactionStatus.initiated
                                                                      ? KColor.pending
                    ...
                    return state.checkedFeeList.length != 0
                        ? Row(
                            ...
                            children: [
                              Expanded(
                                  child:
                                      Container()), // Pushes content to center
                              Padding(
