    ...
    return Column(
      children: [
                ...
                children: [
                  Expanded(
                    child: RefreshIndicator(
                      onRefresh: () => BlocProvider.of<FeeDetailsCubit>(context)
                          .getFeeDetails(),
                            ...
                            return GestureDetector(
                              onTap: () {
                                if (data.feeExempted != feeExempted) {
                                  if (feePayList.contains(data.feeId)) {
                                    feePayList.remove(data.feeId);
                                  } else {
                                    feePayList.add(data.feeId!);
                                  }
                                  setState(() {});
                                  print(feePayList.toString());
                                }
                              },
                              child: Container(
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Expanded(child: Container()), // Pushes content to center
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: SizedBox(
                width: 150,
                  ...
                  onTap: () async {
                    ...
                    bool? response = await showDialog(
                      ...
                      if (value) {
                        CreateFeeModel response = await apiRepo
                            .createFeePayment(
                                feeType: FeeType.tuition, feeID: feePayList)
                            .then((paymentDetails) {
                          if (paymentDetails.success == true &&
                              paymentDetails.data!.data!.atomTokenId != null) {
                            openPay(
                              paymentDetails.data!.data!.atomTokenId.toString(),
                              paymentDetails.data!.data!.merchId.toString(),
                              paymentDetails.data!.data!.custEmail.toString(),
                              paymentDetails.data!.data!.custMobile.toString(),
                              paymentDetails.data!.data!.returnUrl.toString(),
                              paymentDetails.data!.data!.mode.toString(),
                            );
                          } else {
                            TopSnackBar.showError(context,
                                "Unable to make payment, try again later");
