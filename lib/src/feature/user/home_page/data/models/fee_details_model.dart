...
class FeeData {
  ...
  Map<String, dynamic> toJson() => {
    ...
    "payment_for": paymentForValues.reverse[paymentFor],
    "status": status,
    "status_desp": statusDespValues.reverse[statusDesp],
...
final paymentForValues = EnumValues({
  "Tuition Fee": PaymentFor.TUITION_FEE
});
...
final statusDespValues = EnumValues({
  "Unpaid": StatusDesp.UNPAID
});
