...
class ButtonWidget extends StatelessWidget {
  ...
  final double? height;
  const ButtonWidget(
      {super.key, required this.text, required this.onTap, this.fullWidth, this.height,this.color, this.icon});
    ...
    return SizedBox(
      ...
      child: ClipRRect(
        ...
        child: ElevatedButton(
          onPressed: onTap == null ? null : () => onTap!(), // Correctly invoking the onTap function
